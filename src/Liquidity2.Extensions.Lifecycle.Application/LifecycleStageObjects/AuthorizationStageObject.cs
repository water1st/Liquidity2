...
{
    public abstract class AuthorizationStageObject : LifecycleStageObject, IApplicationLifecycleParticipant
    {
        public void Participate(IApplicationLifecycle lifecycle)
        {
            var name = GetType().FullName;
            lifecycle.Subscribe(name, ApplicationLifecycleStages.AUTHORIZATION + SecondaryStage, OnStart, OnStop);
        }
